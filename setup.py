...
setup(
    ...
    url = "https://github.com/Animenosekai/pygooglesearch",
    download_url = "https://github.com/Animenosekai/pygooglesearch/archive/v1.0.0.tar.gz",
    keywords = ['python', 'Anime no Sekai', "animenosekai", "pygooglesearch"],
    ...
    entry_points={
        'console_scripts': [
            'pygooglesearch = pygooglesearch.__main__:main'
        ]
    },
    package_data={
        'pygooglesearch': ['LICENSE'],
    },
)